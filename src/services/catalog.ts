...
export const STT_MODELS: SttModel[] = [
  ...
  },
  {
    ...
    size_mb: 757,
    ram_mb: 1500,
    speed_label: "~3.5x realtime",
    wer: "~3.0%",
    multilingual: false,
    preset: "balanced",
    best_for: "Near-base accuracy at 2-3x speed (distilled English)",
  ...
  },
  {
    ...
    size_mb: 321,
    ram_mb: 800,
    speed_label: "~5x realtime",
    wer: "~3.5%",
    multilingual: false,
    preset: "speed",
    best_for: "Fastest distilled English model, low RAM",
    url: "https://huggingface.co/distil-whisper/distil-small.en/resolve/main/ggml-distil-small.en.bin",
  },
  {
    id: "distil-large-v2",
    file: "ggml-distil-large-v2.bin",
    family: "Distil-Whisper",
    provider: "Hugging Face",
    label: "Distil Large v2",
    size_mb: 1449,
    ram_mb: 3000,
    speed_label: "~2.5x realtime",
    wer: "~3.1%",
    multilingual: false,
    preset: "accuracy",
    best_for: "High accuracy English, fast CPU inference (v2)",
